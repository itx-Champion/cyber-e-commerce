      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="" element={<ProtectedRoute />}>
            ...
            <Route path="/product/shoppingcart/address" element={<AddressPage/>} />
            <Route path="/product/shoppingcart/shipping" element={<Shipping/>} />
            <Route path="/product/shoppingcart/payment" element={<Payment/>}  />
            <Route path="/product/shoppingcart/purchased" element={<PayAfterPage />} />
          </Route>
